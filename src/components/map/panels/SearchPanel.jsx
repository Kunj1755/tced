...
export default function SearchPanel({ onSearchResults }) {
  ...
  const handleSearch = () => {
    ...
    // Mock search results
    const mockResults = [
      { id: 1, name: 'Result 1', attribute: selectedAttribute, value: searchValue, location: 'Zone A' },
      { id: 2, name: 'Result 2', attribute: selectedAttribute, value: searchValue, location: 'Zone B' },
      { id: 3, name: 'Result 3', attribute: selectedAttribute, value: searchValue, location: 'Zone C' },
    ];
        ...
        {selectedLayer && selectedAttribute && (selectedValue || customValue) && (
          <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-slate-700">
              Searching for <span className="font-semibold">{selectedAttribute}</span> = {customValue || selectedValue} in {selectedLayer}
            </p>
          </div>
        )}
      </div>
